...
NET_D['pitch_time_private'] = [
    ('conv3d', (32, (1, 1, 12), (1, 1, 12)), None, 'lrelu'),    # 0 (4, 48, 7)
    ('conv3d', (64, (1, 3, 1), (1, 3, 1)), None, 'lrelu'),      # 1 (4, 16, 7)
]
...
NET_D['shared'] = [
    ...
    ('conv3d', (128, (1, 4, 3), (1, 4, 3)), None, 'lrelu'),     # 1 (4, 1, 1)
]

NET_D['onset'] = [
    ('sum', (3), True),                                         # 0 (4, 48, 1)
    ('conv3d', (32, (1, 3, 1), (1, 3, 1)), None, 'lrelu'),      # 1 (4, 16, 1)
